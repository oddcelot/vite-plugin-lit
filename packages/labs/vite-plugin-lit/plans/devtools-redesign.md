...
| File                     | Changes                                                                                                                                                                                                                          |
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `lit-devtools-panel.ts`  | Import `tokens` + `segmented-tabs`; `[tokens, css`...`]`; replace tab `<button>`s with `<segmented-tabs>`; add flame logo SVG to header; token colors throughout                                                                 |
